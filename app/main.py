import requests
from PyQt5.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QTextEdit, QTextBrowser, QPushButton, QLabel, QSpacerItem, QSizePolicy, QDesktopWidget
    ...
    def append_message(self, message, timestamp, align_right=False):
        ...
        user_style = """
            <div style="display: flex; flex-direction: column; align-items: flex-end; margin-bottom: 10px;">
                ...
                <div style="font-size: 14px; color: gray; text-align: right; margin-top: 5px;">12:05 am</div>
            </div>
        """
